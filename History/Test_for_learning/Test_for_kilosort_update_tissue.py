...
class OpenEphysNeuropixelProcessor:
    ...
    def process_probe(self, probe_name):
        ...
        for recording_index, continuous_file in all_continuous:
            ...
            # e.g. mc015_260314_000759_E1_R1_ProbeB
            tissue_part = f"_{self.tissue}" if self.tissue else ""
            probe_name_dir = (
                f"{self.session_name}"
                f"_{self.session_time}"
                f"{tissue_part}"  # ← insert tissue here
    ...
    def analyze_probe_results(self, probe_results_dir, n_units_to_plot=5):
        ...
        probe_plot_results_dir = probe_results_dir.parent.parent.parent
...
class NeuropixelSessionManager:
    ...
    def _get_session_id(self, session_path):
        ...
        try:
            ...
            if record_node_idx >= 3:
                ...
                session_id = f"{session_name}_{timestamp}_{experiment_name}"
    ...
    def _derive_proc_folder_name(self, session_path, recording_dir, probe_dir):
        ...
        Raw  : .../mc_260315/2026-03-15_21-13-12_s1/Record Node 101/experiment1/
        ...
        rest, time_raw , tissue = timestamp2.split("_")
        # "2026-03-15", "21-13-12"
        ...
        probe_raw = probe_dir.name.split(".")[-1]  # "ProbeA-AP-A"
        probe_name = probe_raw.split("-AP")[0]

        return f"{mouse_id}_{date_str}_{time_str}_{tissue}_{exp_str}_{rec_str}_{probe_name}"
