...
class SessionQualityControlBombCell:
    ...
    def run_bombcell(self) -> bool:
        """
        Run BombCell quality metrics computation.

        Executes the full BombCell pipeline:
        1. Load ephys data from Kilosort outputs
        2. Compute quality metrics
        3. Classify units (good/MUA/noise/non-somatic)
...
class BatchQualityControlProcessor:
    ...
    def __init__(self, processed_root: Path, experimenter_name: str, bin_size: float = 0.1):
        ...
        self.output_base = Path('/Users/shengyuancai/Downloads/Temperal_fig') / experimenter_name
...
Examples:
  ...
  python batch_quality_control_bombcell.py /path/to/proc/data --bin-size 0.05
    ...
    parser.add_argument(
        'processed_root',
        type=str,
        nargs='?',  # makes it optional since it now has a default
        default='/Users/shengyuancai/Downloads/Temperal_fig/mc_proc/',
